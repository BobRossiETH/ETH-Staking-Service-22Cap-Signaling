...
22% control is the threshold where 4 staking entities could collude to attack the Ethereum network. At the same time, any one provider with 22% control over the network can go down without threatening finality. The more decentralized the better, but to maintain a narrow scope the 22% threshold was chosen as the reasonable middleground between all possible thresholds.
